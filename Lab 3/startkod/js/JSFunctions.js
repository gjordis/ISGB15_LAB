...
/*EDIT*/let spelPlanLyss = document.querySelector(".ml-auto"); // Variabel som tilldelas hela spelplanen
...
/*EDIT*/            let spelPlanLyss = document.querySelector(".ml-auto"); // tar bort lyssnare på samma sätt de lades till
                    spelPlanLyss.removeEventListener("click", oGameData.executeMove);
...
/*EDIT*/        document.querySelector("#game-area").classList.add("d-none"); //lägger till klassen "d-none" på elementet med id "game-area" när spelet är slut
